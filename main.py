...
class AssistantWindow:
    ...
    def show_functionalities(self):
        functionalities = (
            ...
            "1. Search Wikipedia            12. Tell the current time\n"
            "2. Open YouTube                13. Take a screenshot\n"
            "3. Play a video on YouTube     14. Close YouTube\n"
            "4. Get the latest news         15. Close Google\n"
            "5. Provide weather information  16. Exit the assistant\n"
            "6. Tell a joke                 17. Sleep mode\n"
            "7. Perform calculations         18. Open Google Calculator\n"
            "8. Send email                  19. Get IP address\n"
            "9. Close current tab           20. Get current day\n"
...
def process_query(query):
    ...
    if gui_active:
        ...
        # Check for play music command
            ...
            try:
                # Use raw string and forward slashes for path
                music_dir = r"D:\python\Nova\Nova\Nova\myad"
